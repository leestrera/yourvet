  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
      <div style={{ marginBottom: '2rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
        ...
        <h2 style={{ margin: 0, fontWeight: 800 }}>Add New Service</h2>
      </div>

      <div className="form-card">
        <form action={addService} className="admin-form">
          <div className="form-section">
            ...
            <div className="form-grid">
              <div className="form-group form-group-full">
                ...
                <input type="text" name="name" required placeholder="e.g. Annual Wellness Exam" />
              </div>
          ...
          <div className="form-section">
            ...
            <div className="form-grid">
              ...
              <div className="form-group">
                ...
                <input type="number" name="duration_min" placeholder="30" />
              </div>
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div className="form-group" style={{ flexDirection: 'row', alignItems: 'center', gap: '0.5rem' }}>
              <input type="checkbox" name="is_active" defaultChecked id="is_active" style={{ width: 'auto' }} />
              <label htmlFor="is_active" style={{ margin: 0 }}>Active (Available for booking)</label>
            </div>
            <div className="form-group" style={{ marginTop: '1rem' }}>
                <label>Display Order</label>
                <input type="number" name="display_order" defaultValue={0} style={{ maxWidth: '150px' }} />
            </div>
          </div>
