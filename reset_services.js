...
async function reset() {
  console.log('Clearing old duplicates...');
  // Delete all services where id > 0
  await supabase.from('services').delete().gt('service_id', 0);
  
  console.log('Re-seeding single copies...');
